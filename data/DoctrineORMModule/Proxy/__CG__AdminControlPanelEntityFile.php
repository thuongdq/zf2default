 ...
 */
class File extends \AdminControlPanel\Entity\File implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'filename', 'label', 'dateCreated', 'user', 'sharing'];
        }
