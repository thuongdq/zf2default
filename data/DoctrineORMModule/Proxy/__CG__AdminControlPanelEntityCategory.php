 ...
 */
class Category extends \AdminControlPanel\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'parent', 'child', 'posts', 'products'];
        }
     ...
     * {@inheritDoc}
     */
    public function setParent(\AdminControlPanel\Entity\Category $parent = NULL)
    {
