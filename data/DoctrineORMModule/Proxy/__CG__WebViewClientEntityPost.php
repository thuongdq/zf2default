 ...
 */
class Post extends \WebViewClient\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'title', 'info', 'content', 'status', 'dateCreated', 'category', 'tags', 'comments'];
        }
